package com.newsfeedassignment.data.paging
...
class NewsRemoteMediatorTest {
    ...
    private val state = PagingState<Int, com.newsfeedassignment.data.persistence.CachedArticleEntity>(emptyList(), null, PagingConfig(10), 0)
