package com.newsfeedassignment.data.search
...
import com.newsfeedassignment.data.network.toDomain
import com.newsfeedassignment.data.network.toNewsError
import com.newsfeedassignment.data.paging.NewsPagingException
...
class NewsSearchPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        ...
        return try {
            ...
            LoadResult.Error(if (error is IllegalArgumentException) NewsPagingException(com.newsfeedassignment.core.model.NewsError.Validation) else NewsPagingException(error.toNewsError()))
        }
    }
